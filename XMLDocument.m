...
-(BOOL)parseRemoteXMLWithURL:(NSString *)paramRemoteXMLURL{
    ...
    [self.delegate xmlDocumentDelegateDownloadingStarted:self];
    /*
    activityIndicator=[[UIActivityIndicatorView alloc]initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
    activityIndicator.frame=CGRectMake(142, 222, 36, 36);
    examIndex *newExamIndex=[[examIndex alloc]init];
    newExamIndex.activityIndicator=self.activityIndicator;
    [newExamIndex.activityIndicator startAnimating];
    */
